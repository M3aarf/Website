<?php $__env->startSection('pageTitle',  "السيرة الذاتية السى فى  - منصة معارف"); ?>
<?php $__env->startSection('pageDesc', "السيرة الذاتية او ما يعرف بال CV هو من اهم الخطوات و الامور التى تساعدك فى التقديم و القبول فى الوظيفة التى تريد الالتحاق بيها بداخل منصة معارف سوف تتعرف على نصائح كتابة السيرة الذاتية بشكل صحيح"); ?>
