...
$(document).ready(function() {
    oTable = $('#cats_courses').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('datatable.getCatCourses') }}",
        "columns": [
            {data: 'id', name: 'id'},
            {data: 'title', name: 'title'},
            {data: 'views', name: 'views',searchable:false},
...
$(document).ready(function() {
    ...
    oTable = $('#lessons').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax":"{{url('datatable/getLessons/')}}"+"/"+course_id,
        "columns": [
            {data: 'id', name: 'id'},
            {data: 'title', name: 'title'},
...
$(document).ready(function() {
    ...
    oTable = $('#tracks').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax":"{{ route('datatable.getTracks') }}",
        "columns": [
            {data: 'id', name: 'id'},
            {data: 'title', name: 'title'},
            {data: 'views', name: 'views'},
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('admin/tips/delete_tip/')}}"+"/"+del_id,
                data: info,
                success: function()
                {
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('/admin/tracks/delete_tracks/')}}"+"/"+del_id,
                data: info,
                success: function()
                {
                $('.page-header').append("<div class='alert alert-success text-center' dir='rtl'>تم المسح بنجاح</div>");    
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('admin/articles/delete_post/')}}"+"/"+del_id,
                data: info,
                success: function()
                {
                $('.page-header').append("<div class='alert alert-success text-center' dir='rtl'>تم المسح بنجاح</div>");    
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('admin/articles/delete_cat/')}}"+"/"+del_id,
                data: info,
  ...
  function delete_cat_courses(id)
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('admin/courses/delete_cat/')}}"+"/"+del_id,
                data: info,
                success: function(response)
                {
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('admin/courses/delete_course')}}"+"/"+del_id,
                data: info,
                success: function(response)
                {
               ...
               function delete_lesson(id)
    {
        ...
        if(confirm("Are you sure you want to delete this Record?")){
            $.ajax({
               headers: {
                ...
                type: "POST",
                url: "{{url('/admin/course/delete_lesson/')}}/"+del_id,
                data: info,
                success: function(response)
                {
        ...
        $("#add_lesson_form").on('submit',function(event){
            ...
            $.ajax({
                url:"{{url('/admin/course/add_lesson/')}}",
                method:"POST",
                data:form_data,
                datatype:"json",
                success:function(response)
