...
@section('pageTitle',  "نصائح سفر - منصة معارف")
@section('pageDesc',  "نصائح سفر عليك ان تعلمها قبل ان تذهب لرحلتك القادمة نصائح فى البلاد و نصائح للطيران ونصائح فى تحضير اوراق السفر و التأشيرات وغيره من النصائح الهامة فى السفر")
