...
class nooor extends Controller
{
	...
	{
         $link = "https://www.noor-book.com/%D9%83%D8%AA%D8%A8-%D8%A7%D9%84%D9%85%D8%B9%D8%A7%D8%AC%D9%85-%D9%88%D8%A7%D9%84%D9%82%D9%88%D8%A7%D9%85%D9%8A%D8%B3-pdf"; 
		$c = curl_init();
        ...
        $node = $finder->query("//div[@class='book-restult']/a/h3");
        $count = count($node);
		for($i=0 ; $i<$count ;$i++)
        {
			$link  = $node->item($i)->textContent;
		    echo $link;
			echo "<br>";
